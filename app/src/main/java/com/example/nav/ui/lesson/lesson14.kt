...
class lesson14 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_lesson14, container, false)
        ...
        val videoPath = "android.resource://${requireActivity().packageName}/${R.raw.l4}"
