...
class lesson12 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_lesson12, container, false)
        ...
        val videoPath = "android.resource://${requireActivity().packageName}/${R.raw.l2}"
